...
//		서비스 컨트롤러에서 비밀번호를 암호화해서 정보가 기입
		MemberServiceImpl service=new MemberServiceImpl();
//		service.memberJoin(new MemberDto(5,"yws078","1234","이동환", "yws078@naver.com", "010-8600-0787"));
		
//		로그인성공 
//		Map<String,Object>islogin1=service.login("이동환", "1234", 0);
//		System.out.println("isLogin:"+islogin1);
		
//		로그인 실패 -패스워드가 잘못입력됐을때
//		Map<String,Object>isLogin2=service.login("이동환", "1111", 0);
